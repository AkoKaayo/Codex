...
@app.route("/custom_partial")
def custom_partial():
    return render_template("custom_partial.html")

@app.route("/apprentice_partial")
def apprentice_partial():
    return render_template("apprentice_partial.html")
